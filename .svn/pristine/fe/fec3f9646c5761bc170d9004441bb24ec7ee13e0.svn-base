<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="MenuGroupList.aspx.cs" Inherits="globalfx.setting.AppMenu.MenuGroupList" %>
                        ...
                        <div class="span12">
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <asp:Button ID="getGroupListButton" runat="server" Text="Get Group List" CssClass="btn btn-info btn-sm"
                                        OnClick="getGroupListButton_Click" />
                                    <asp:Button ID="getAllGroupListButton" runat="server" Text="Get All Group List" CssClass="btn btn-info btn-sm"
