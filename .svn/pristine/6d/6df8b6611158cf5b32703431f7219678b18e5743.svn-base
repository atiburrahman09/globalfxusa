                        ...
                        <div class="grid-body">
                            <div class="row-fluid">
                                <div class="control-group open">
                                    ...
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlstakeList" CssClass="span8" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="control-group open">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtbxNoStake" type="number" class="span8" placeholder="No. of KEY" AutoPostBack="True" runat="server" OnTextChanged="txtbxNoStake_TextChanged"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="control-group open">
                                    <label class="semi-bold">Payment By</label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlPaymentBy" CssClass="span8" runat="server">
                                            <asp:ListItem Value="1">Income Wallet</asp:ListItem>
                                            <asp:ListItem Value="2">FX Fund</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="pull-left">
                                    ...
                                    <asp:Button ID="btnPurches" CssClass="btn btn-primary btn-cons" runat="server" Text="Purches Request" OnClick="btnPurches_Click" />
                ...
                <div class="span6">
                    <div class="grid simple horizontal red">
                        ...
                        <div class="grid-body">
                            <div class="row-fluid">
                                <div class="span6">
                                    <h5 class="text-center">Income <span class="semi-bold">Wallet</span></h5>
                                    <div class="row-fluid">
                                        <div class="control-group">
                                            <div class=" total_count">
                                                <p>
                                                    <asp:Label class="text-center font20" ID="lblIncome" runat="server" Text="0.00"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="span6">
                                    <h5 class="text-center">Fx <span class="semi-bold">Fund</span></h5>
                                    <div class="row-fluid">
                                        <div class="control-group">
                                            <div class=" total_count">
                                                <p>
                                                    <asp:Label class="text-center font20" ID="lblFxFund" runat="server" Text="0.00"></asp:Label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row-fluid">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th width="170" class="text-left">Stake Name</th>
                                            <th width="30" class="unseen text-center">QTY</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblStakeName" runat="server" Text="Sate Name"></asp:Label></td>
                                            <td class="unseen text-center">
                                                <asp:Label ID="lblQuntity" runat="server" Text="0"></asp:Label></td>

                                            <td class="text-right">
                                                <asp:Label ID="lblUnitPrice" runat="server" Text="0.00"></asp:Label></td>
                                            <td class="text-right">
                                                <asp:Label ID="lblPrice" runat="server" Text="0.00"></asp:Label></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><strong>
                                                <asp:Label ID="lblTotalPrice" runat="server" Text="0.00"></asp:Label></strong></td>
                                        </tr>
