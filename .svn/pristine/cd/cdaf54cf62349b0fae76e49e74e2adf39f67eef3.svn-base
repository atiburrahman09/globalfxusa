...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <div class="grid simple">
        ...
        <asp:Label ID="lvlSuccess" runat="server" Text=""></asp:Label>
        <div class="grid-body">
                ...
                <div class="row-fluid column-seperation">
                            ...
                            <div class="span11">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="rqrvalidpass" ControlToValidate="txtpxPasswordset"
                                            ErrorMessage="Please fill the field" Display="Dynamic" ForeColor="red" runat="server" /><br />
                                ...
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:CompareValidator ID="cmvPasswordRpt" runat="server" Display="Dynamic" EnableClientScript="true"
                                            ControlToValidate="txtpxPasswordset" ValidateEmptyText="true"
                            ...
                            <div class="span11">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtbxPin"
                                            ErrorMessage="Please fill the field" Display="Dynamic" ForeColor="red" runat="server" /><br />
                                ...
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" Display="Dynamic" EnableClientScript="true"
                                            ControlToValidate="txtbxPin" ValidateEmptyText="true"
                    ...
                    <div class="span6">
                            ...
                            <div class="span12">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtcontactPerson"
                                            ErrorMessage="Please fill the field" Display="Dynamic" ForeColor="red" runat="server" /><br />
                            ...
                            <div class="span12">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="ddlContactRelation"
                                            ErrorMessage="Please fill the field" Display="Dynamic" ForeColor="red" runat="server" />
                            ...
                            <div class="span12">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtbxContactMobile"
                                            ErrorMessage="Please fill the field" Display="Dynamic" ForeColor="red" runat="server" /><br />
                            ...
                            <div class="span12">
                                <div class="control-group">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="ddlContactCountry"
                                            ErrorMessage="Please Select one." Display="Dynamic" ForeColor="red" runat="server" /><br />
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="btn-group open">
                                        <label class="semi-bold">Express ID</label>
                                ...
                                <div class="span5">
                                    <div class="input-with-icon  right">
                                        ...
                                        <asp:DropDownList ID="ddlPosition" AutoPostBack="True" runat="server" OnSelectedIndexChanged="ddlPosition_SelectedIndexChanged">
                            ...
                            <asp:HiddenField ID="hdnvalidplace" runat="server" />
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="btn-group open">
