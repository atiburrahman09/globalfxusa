    ...
    public partial class create : System.Web.UI.Page
    {
        ...
        protected void EditLinkButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                txtBxAmount.Text = gridviewStake.Rows[row.RowIndex].Cells[2].Text.ToString();
                txtBxAwardFrom.Text = gridviewStake.Rows[row.RowIndex].Cells[3].Text.ToString();
                txtBxAwardTo.Text = gridviewStake.Rows[row.RowIndex].Cells[4].Text.ToString();
                txtBxAvarage.Text = gridviewStake.Rows[row.RowIndex].Cells[5].Text.ToString();
                txtBxDuration.Text = gridviewStake.Rows[row.RowIndex].Cells[6].Text.ToString();
                txtBxBainoryCap.Text = gridviewStake.Rows[row.RowIndex].Cells[7].Text.ToString();
                txtBxCommission.Text = gridviewStake.Rows[row.RowIndex].Cells[8].Text.ToString();
