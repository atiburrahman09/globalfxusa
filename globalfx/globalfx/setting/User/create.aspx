                    ...
                    <div class="grid-body">
                        ...
                        <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="span4">
                                        <div class="control-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rqrvalidpass" ValidationGroup="2" ControlToValidate="passwordTextBox"
                                    ...
                                    <div class="span4">
                                        <div class="control-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvConPassword" ControlToValidate="confirmPasswordTextBox"
                                                ErrorMessage="*" Display="Dynamic" ValidationGroup="2" ForeColor="red" runat="server" />
                            ...
                            <div class="span12">
                                <div class="row-fluid ">
                                    <div class="span12">
                                        <asp:Button ID="saveButton" runat="server" ValidationGroup="2" Text="Create" CssClass="btn btn-primary"
