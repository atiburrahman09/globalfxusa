                            ...
                            <div class="row-fluid">
                                <asp:GridView ID="userListGridView" runat="server" AutoGenerateColumns="false" CssClass="table table-hover">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="UserPIN" HeaderText="PIN" />
                                        <asp:BoundField DataField="UserPass" HeaderText="Pass" />
                                        <asp:BoundField DataField="UserBlock" HeaderText="Is Block" />
                                        ...
                                        <asp:TemplateField HeaderText="Activation">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="blockLinkButton" runat="server" CssClass="btn btn-mini btn-success" 
                                                    OnClick="blockLinkButton_Click" OnClientClick="return confirm('Are you sure you want to activate this Key?');"><%# Eval("IsBlocked")%></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
