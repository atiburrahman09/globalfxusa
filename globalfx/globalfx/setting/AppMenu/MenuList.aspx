<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="MenuList.aspx.cs" Inherits="globalfx.setting.AppMenu.MenuList" %>

<asp:Content ID="headContent" ContentPlaceHolderID="headPlaceHolder" runat="server">
    <link href="/Content/Style/PageCSS/AppMenuList.css" rel="stylesheet" type="text/css" />
        ...
        <div class="row widget-container-col ui-sortable" style="min-height: 261px;">
            <div class="panel panel-primary" style="opacity: 1;">
                ...
                <div class="grid-body">
                        ...
                        <div class="span12">
                            ...
                            <div class="span3">
                                <div class="control-group">
                                   ...
                                   <%-- OnSelectedIndexChanged="menuLevelDropDownList_SelectedIndexChanged"--%>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="span12">
                            <asp:Button ID="getMenuListButton" runat="server" style="margin-left: 25px;" Text="Get Menu List" CssClass="btn btn-info"
