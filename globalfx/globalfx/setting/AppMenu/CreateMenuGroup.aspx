<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="CreateMenuGroup.aspx.cs" Inherits="globalfx.setting.AppMenu.CreateMenuGroup" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid-fluid widget-container-col ui-sortable" style="min-height: 261px;">
            <div class="panel panel-primary" style="opacity: 1;">
                <div class="panel-heading">
                    <h5 class="widget-title bigger lighter">
                        <i class="icon icon-table"></i>Create Menu Group
                    </h5>
                </div>
                <div class="grid-body">
                    <div class="row-fluid">
